...
public record ContactData(String id, String firstname, String lastname, String address, String email, String mobile, String email2, String home) {
    ...
    public ContactData withLastName(String lastname) {
        return new ContactData(this.id, this.firstname, lastname, this.address, this.email, this.email2, this.mobile, this.home);
    }

    public ContactData withAddress(String address) {
        return new ContactData(this.id, this.firstname, this.lastname, address, this.email, this.email2, this.mobile, this.home);
    }
